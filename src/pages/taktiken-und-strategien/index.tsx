        ...
        <article className="space-y-8 sm:space-y-10">
          ...
          <section className="border-t border-[#f0eee7] pt-8">
            ...
            <ul className="font-inter text-[15px] text-[#5f5b53] leading-[1.7] space-y-3 list-disc pl-5">
              ...
              <li>
                <Link href="/taktiken-und-strategien/kommunikation-signale/hoch-tief-tief-hoch/" className="text-[#ff0000] hover:underline font-medium">Hoch-tief / Tief-hoch</Link>:
          ...
          <section className="border-t border-[#f0eee7] pt-8">
            ...
            <div className="font-inter text-[15px] text-[#5f5b53] leading-[1.7] space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><Link href="/taktiken-und-strategien/kommunikation-signale/hoch-tief-tief-hoch/" className="text-[#ff0000] hover:underline font-medium">Hoch-tief / Tief-hoch</Link>: die Anzahl Trümpfe anzeigen.</li>
